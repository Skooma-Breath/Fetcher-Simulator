...
local RECORD_TYPE_DEFS = {
    ...
    { id = "creature", defaultBaseId = "mudcrab", defaultName = "RecordDynamic Test Creature", canPlace = false, hint = "/spawnat still needs actor authority" },
    ...
    { id = "npc", defaultBaseId = "fargoth", defaultName = "RecordDynamic Test NPC", canPlace = false, hint = "/spawnat still needs actor authority" },
